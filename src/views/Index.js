      ...
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            ...
            <div className="pt-32 sm:pt-0">
              <h2 className="font-bold text-5xl text-lightBlue-600">
                Collaborative
              </h2>
            </div>
            <div className="pt-32 sm:pt-5">
              <h2 className="font-bold text-5xl text-lightBlue-600">
                Grow With Us
              </h2>
            </div>
      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
        ...
        <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4 ">
            <h3 className="text-5xl font-bold text-red-500">What We Offer</h3>
      ...
      <section className="py-1 bg-blueGray-600 overflow-hidden">
        <div className="container mx-auto pb-64">
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-5/12 px-56 md:px-4 ml-auto mr-auto md:mt-58">
              {/* <div className="text-blueGray-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                <i className="fas fa-code-branch text-xl"></i>
              </div> */}
              <h3 className="text-5xl mb-2 font-bold leading-normal text-white">
                Why HKS ?
              </h3>
